...
# the "."
# so 0000.493 is illegal, 000000 is illegal and 0. is illegal, but 0.0 is legal and 0 is legal. 0. is not legal
...
exponent_parser = NotParser(multiple_zero_parser) & (sign_parser + whole_number_parser)
